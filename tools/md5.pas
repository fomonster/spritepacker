...
function Md5x1(const S:String):String;
function Md5x2(const S:String):String;
function Md5x3(const S:String):String;
function Md5x4(const S:String):String;

implementation

function Md5x1(const S:String):String;
begin
  result:=MD5DigestToStr(md5.MD5String(S));
end;

function Md5x2(const S:String):String;
begin
  result:=MD5DigestToStr(md5.MD5String(MD5DigestToStr(md5.MD5String(S))));
end;

function Md5x3(const S:String):String;
begin
  result:=MD5DigestToStr(md5.MD5String(MD5DigestToStr(md5.MD5String(MD5DigestToStr(md5.MD5String(S))))));
end;

function Md5x4(const S:String):String;
begin
  result:=MD5DigestToStr(md5.MD5String(MD5DigestToStr(md5.MD5String(MD5DigestToStr(md5.MD5String(MD5DigestToStr(md5.MD5String(S))))))));
end;
